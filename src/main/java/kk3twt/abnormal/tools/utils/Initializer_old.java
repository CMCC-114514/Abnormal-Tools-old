...
public class Initializer_old extends JDialog {
     ...
     */
    public Initializer_old(boolean downloadMode) {
        ...
        Downloader downloader = new Downloader(target, url) {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(Initializer_old.this,
                            "下载失败: " + e.getMessage(),
                            "错误",
    ...
    public static boolean isInitialized() {
        ...
        try {
            if (SwingUtilities.isEventDispatchThread()) {
                ...
                SwingUtilities.invokeAndWait(Initializer_old::runInitialization);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null,
    ...
    private static void runInitialization() {
        ...
        try {
            if (!Files.exists(resources)) {
                new Initializer_old(true).setVisible(true);
            } else {
                new Initializer_old(false).setVisible(true);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null,
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Initializer_old(true).setVisible(true));
    }
}